 ...
 * 6. Finding the position of the maximum element within a range
 *
...
public class ArrayMultiTinyProjectsV2 {
    ...
    public static void main(String[] args) {
        ...
        maximumPosition = getMaxPosition(arr, minimumValue, arr.length - 1 );
        System.out.println("Maximum position is: " + maximumPosition);
    }
    ...
    /**
     * Finds the position of the maximum element in the array
     ...
     * @return       the index of the maximum element in the range [low, high],
     *               or -1 if the array is null, empty, or the range is invalid.
     */
